      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black tracking-tight text-gray-900 mb-2">
            HotsNew <span className="text-orange-600 uppercase italic">click</span>
          </h1>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Tiếp thị liên kết thông minh</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden relative">
          ...
          <div className="relative flex items-center py-4">
            ...
            <span className="flex-shrink mx-4 text-[10px] font-black uppercase tracking-widest text-gray-300">Hoặc</span>
            <div className="flex-grow border-t border-gray-100"></div>
          </div>
          ...
          >
            <img src="https://lh3.googleusercontent.com/COxitqzZInE1pNp_PsSUsUou9YI-BgeRR_Y8ynNAtXFAn8AuvmS7sc0p76WpWqqi9In0lg" alt="Google" className="w-5 h-5" />
            Sử dụng Google
          </button>
        </div>
